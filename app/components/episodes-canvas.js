SRC = `https://res.cloudinary.com/aliencyborg-llc/image/upload/${SCALE}/v1555733625/shangri-lashow/Episodes%20Page/Tape10.png`
...
const TV_BACKGROUND_SRC = `https://res.cloudinary.com/aliencyborg-llc/image/upload/v1555452236/shangri-lashow/Episodes%20Page/TVwithBackground1920w.png`
...
export default class EpisodesCanvasComponent extends Component {
  ...
  setup = async () => {
    ...
    const tape01Img = buildImage(tape01ImageObj, `tape01`, 1200, 285)
    const tape02Img = buildImage(tape02ImageObj, `tape02`, 1200, 371)
    const tape03Img = buildImage(tape03ImageObj, `tape03`, 1200, 453)
    const tape04Img = buildImage(tape04ImageObj, `tape04`, 1200, 539)
    const tape05Img = buildImage(tape05ImageObj, `tape05`, 1200, 628)
    const tape06Img = buildImage(tape06ImageObj, `tape06`, 1200, 710)
    const tape07Img = buildImage(tape07ImageObj, `tape07`, 1200, 793)
    const tape08Img = buildImage(tape08ImageObj, `tape08`, 1200, 874)
    const tape09Img = buildImage(tape09ImageObj, `tape09`, 1200, 959)
    const tape10Img = buildImage(tape10ImageObj, `tape10`, 1200, 1043)
    const tape11Img = buildImage(tape11ImageObj, `tape11`, 1200, 1130)
    const tape12Img = buildImage(tape12ImageObj, `tape12`, 1200, 1210)
    const tape13Img = buildImage(tape13ImageObj, `tape13`, 1200, 1296)
    ...
    await imagePromise(ep04RowImageObj, EP_04_ROW_SRC)
    await imagePromise(ep04LRowImageObj, EP_04_ROW_L_SRC)
    await imagePromise(ep05RowImageObj, EP_05_ROW_SRC)
    await imagePromise(ep05LRowImageObj, EP_05_ROW_L_SRC)
    await imagePromise(ep06RowImageObj, EP_06_ROW_SRC)
    await imagePromise(ep06LRowImageObj, EP_06_ROW_L_SRC)
    await imagePromise(ep07RowImageObj, EP_07_ROW_SRC)
    await imagePromise(ep07LRowImageObj, EP_07_ROW_L_SRC)
    await imagePromise(ep08RowImageObj, EP_08_ROW_SRC)
    await imagePromise(ep08LRowImageObj, EP_08_ROW_L_SRC)
    await imagePromise(ep09RowImageObj, EP_09_ROW_SRC)
    await imagePromise(ep09LRowImageObj, EP_09_ROW_L_SRC)
    await imagePromise(ep10RowImageObj, EP_10_ROW_SRC)
    await imagePromise(ep10LRowImageObj, EP_10_ROW_L_SRC)
    await imagePromise(ep11RowImageObj, EP_11_ROW_SRC)
    await imagePromise(ep11LRowImageObj, EP_11_ROW_L_SRC)
    await imagePromise(ep12RowImageObj, EP_12_ROW_SRC)
    await imagePromise(ep12LRowImageObj, EP_12_ROW_L_SRC)
    await imagePromise(ep13RowImageObj, EP_13_ROW_SRC)
    await imagePromise(ep13LRowImageObj, EP_13_ROW_L_SRC)
